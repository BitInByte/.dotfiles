...
local function mix_colours(color_1, color_2, weight)
  ...
  for i = 2, 6, 2 do -- loop through each of the 3 hex pairsred, green, and blue
    ...
    while (string.len(val) < 2) do
      val = "0" .. val
    end -- prepend a '0' if val results in a single digit
...
gls.left[2] = {
  ...
  LspServer = {
    ...
    -- condition = function()
    -- 	local curr_client = lspclient.get_lsp_client()
    -- 	return curr_client ~= "No Active Lsp"
    -- end,
    -- separator = "",
...
gls.left[3] = {
  GitIcon = {
    ...
    -- separator = ' ',
    separator_highlight = "GalaxySection2",
    highlight = "GalaxySection2"
  }
}
  ...
  LineColumn = {
    provider = function()
      ...
      if mode == "v" or mode == "V" or mode == "" then -- visual mode (show selection)
        ...
        return "  " ..
          lstart ..
            ":" .. lend .. "/" .. vim.fn.line("$") .. "  " .. cstart .. ":" .. cend .. "/" .. vim.fn.col("$") .. " "
      else
        return "  " ..
