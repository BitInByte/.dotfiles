# Generated by Powerlevel10k configuration wizard on 2021-05-07 at 20:03 WEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=87
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=241
  ...
  function my_git_formatter() {
    ...
    local       meta='%51F' # white foreground
    # local      clean='%0F' # black foreground
    local      clean='%15F' # black foreground
    # local   modified='%0F' # black foreground
    local   modified='%157F' # black foreground
    # local   modified='%0F' # black foreground
    # local  untracked='%0F' # black foreground
    local  untracked='%63F' # black foreground
    # local conflicted='%1F' # red foreground
    local conflicted='%9F' # red foreground

    local staged='%11F'

    local commits_ahead='%91F'
